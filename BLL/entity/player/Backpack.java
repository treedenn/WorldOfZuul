...
/**
 * Backpack is an inventory, based on the inventory interface.
...
public class Backpack implements Inventory {
	...
	/**
	 * Constructs a new Backpack with a maximum capacity in weight.
	 * @param maxCapacity max weight
	 */
	...
	/**
	 * {@inheritDoc}
	 * Gets the maximum capacity in weight.
	 */
	@Override
	...
	/**
	 * {@inheritDoc}
	 * Gets the current capacity in weight.
	 */
	@Override
